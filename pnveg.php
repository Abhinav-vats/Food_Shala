	...
	<body class ="text_font fade" data-spy="scroll" data-target=".abhi">
		<nav class="navbar abhi navbar-fixed-top" style="background-color: #875050;">
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><div class="dropdown-toggle cl_white" data-toggle="dropdown">Menu <span class="caret"></span></div>
						...
						<?php
							while($row=mysqli_fetch_assoc($result))
							{
								...
								<tr>
									...
									<td>
										<button type="submit" name="addtocart" id="add" style="color:#fff; background-color:#F18646;" class="btn col-md-12 btn-next">ADD</button>
									</td>
