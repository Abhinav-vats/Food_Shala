		...
		<section class= "form-box">
			<form role="form" method="POST">
				<div class="container-fluid">
					<table class="table">
						<tr>
							<th colspan="5"><div align = "center" ><h3  style="color:#2F7306;"><b>Non-Veg Foods</b></h3></div></th>
						</tr>
						<tr>
							<th>
							...
							<th>
								<h3  style="color:#2F7306;"><b>Add to Cart</b></h3>
							</th>
						</tr>
						<?php
							while($row=mysqli_fetch_assoc($result))
							{
								...
								<tr>
									...
									<td><button type="submit" name="addtocart" id="add" style="color:#fff; background-color:#F18646;" class="btn col-md-12 btn-next">ADD</button></td>
